function startGame() {
  const cardsQuantity = prompt(
    "Com quantas cartas você deseja jogar? Por favor, informe um número par entre 2 e 14"
  );
    ...
    for (i = 0; idList.length < idToHide; i++) {
        ...
        for (i = 0; i <= idToHide; i++) {
            ...
            if ((idList[i] = 1)) {
                ...
                console.log(idList[idToHide], "Oculta 1 par (em teoria)");
            } else if ((idList[i] = 2)) {
                card2.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 2 par (em teoria)");
            } else if ((idList[i] = 3)) {
                card3.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 3 par (em teoria)");
            } else if ((idList[i] = 4)) {
                card4.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 4 par (em teoria)");
            } else if ((idList[i] = 5)) {
                card5.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 5 par (em teoria)");
            } else if ((idList[i] = 6)) {
                card6.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 6 par (em teoria)");
            } else if ((idList[i] = 7)) {
                card7.classList.toggle("hidden");
                console.log(idList[idToHide], "Oculta 7 par (em teoria)");
            }
        }
    }
    // let random = (Math.floor(Math.random() * cardsToToggle) + 1)
